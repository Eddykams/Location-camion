...
<title>Camions | Admin Gestion Reservation</title>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h2 class="page-title">Gestion Reservation</h2>

                <!-- Zero Configuration Table -->
                <div class="panel panel-default">
                    <div class="panel-heading">Information Reservation</div>
...
echo htmlentities('Cancelled');
                                ...
                                <td><a href="manage-bookings.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Voulez vous confirmer cette reservation?')"> Confirmer</a> /


<a href="manage-bookings.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Voulez vous annuler cette reservation?')"> Annuler</a>
</td>
