			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Image 1 camions </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Details Image camions 1</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Image courant</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Chaegez nouvelle image<span style="color:red">*</span></label>
												<div class="col-sm-8">
