...
<head>
	...
	<title>Camions | Modifier Vehicule</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Modifier Camions</h2>
...
<label class="col-sm-2 control-label">Nom camion<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="vehicletitle" class="form-control" value="<?php echo htmlentities($result->VehiclesTitle)?>" required>
</div>
<label class="col-sm-2 control-label">Choisir Marque<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Apercu camion<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<label class="col-sm-2 control-label">Tonnage<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<button class="btn btn-primary" name="submit" type="submit" style="margin-top:4%">Sauvegarder</button>
												</div>
											</div>
