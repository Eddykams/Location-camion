...
<head>
	...
	<title>Camions | Creer Marque</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Mise a jour Information contact</h2>
...
<div class="form-group">
												<label class="col-sm-4 control-label"> Numero contact </label>
												<div class="col-sm-8">
...
<?php }} ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="submit" type="submit">Mise a jour</button>
												</div>
											</div>
