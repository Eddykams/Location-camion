			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Modification Mot de passe</h2>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERREUR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
				else if($msg){?><div class="succWrap"><strong>REUSSITE</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Confirmé Mot de passe</label>
												<div class="col-sm-8">
