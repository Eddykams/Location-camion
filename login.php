...
?>
                        ...
                        <form method="post">
                            ...
                            <div class="log-btn">
                                <button type="submit" name="login" value="Login"><i class="fa fa-sign-in"></i> Connectez vous</button>
                            </div>
                        </form>
                    </div>

                    <div class="create-ac">
                        <p>Pas de compte? <a href="registration.php" name="signupform">Enregistrez vous</a></p>
                    </div>
