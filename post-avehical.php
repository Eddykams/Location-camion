...
if($lastInsertId)
{
$msg="Vehicule posté avec succes";
}
else 
{
$error="Reessayez svp!!!";
...
<head>
	...
	<title>Camions | Poster camions </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">POSTER CAMIONS</h2>

						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Information Formulaire</div>
...
<label class="col-sm-2 control-label">Choisir Modèle<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Commentaires vehicules<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<div class="form-group">
<label class="col-sm-2 control-label">Prix(En USD)<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="priceperday" class="form-control" required>
</div>
<label class="col-sm-2 control-label">Choisir Type carburant<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label class="col-sm-2 control-label">Kilometrage<span style="color:red">*</span></label>
<div class="col-sm-4">
